...
Due to the way sprinting is implemented on the client, it is not possible to completely remove all server-side influence on sprinting. On high ping, certain sprinting glitches can occur, when:
